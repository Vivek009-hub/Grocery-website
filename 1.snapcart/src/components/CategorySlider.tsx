'use client'
import { Apple, Baby, Box, ChevronLeft, ChevronRight, Coffee, Cookie, Flame, Heart, Home, Milk, Wheat,Leaf  } from 'lucide-react'
import React, { useEffect, useRef, useState } from 'react'
import {motion} from "motion/react"
function CategorySlider() {
    const categories=[
  { id: 1, name: "Jaggery Powder", icon: Leaf, color: "bg-green-100" },
  { id: 2, name: "Haldi Flavour", icon: Milk, color: "bg-yellow-100" },
  { id: 3, name: "Sooap Flavour", icon: Wheat, color: "bg-orange-100" },
  { id: 4, name: "Coconut Flavour", icon: Leaf , color: "bg-pink-100" },
  { id: 5, name: "Mix Dry Fruits flavour", icon: Cookie, color: "bg-red-100" },
  { id: 6, name: "Beverages & Drinks (Coming Soon...)", icon: Coffee, color: "bg-blue-100" },
  { id: 7, name: "Personal Care (Coming Soon...)", icon: Heart, color: "bg-purple-100" },
  { id: 8, name: "Household Essentials (Coming Soon...)", icon: Home, color: "bg-lime-100" },
  { id: 9, name: "Instant & Packaged Food (Coming Soon...)", icon: Box, color: "bg-teal-100" },
