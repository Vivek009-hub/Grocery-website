  ...
  return (
    ...
    >
        <div className='w-[90%] md:w-[80%] mx-auto py-10 grid grid-cols-1 md:grid-cols-3 gap-10 border-b border-green-500/40'>
          <div>
<h2  className='text-2xl font-bold mb-3'>Canson</h2>
<p className='text-sm text-green-100 leading-relaxed'> Your one-stop online jaggery store delivering freshness to your doorstep.  
     ...
     <h3 className="text-xl font-semibold mb-3">Contact Us</h3>
          <ul className="space-y-2 text-green-100 text-sm">
            <li className="flex items-center gap-2">
              <MapPin size={16} /> Uttar Pradesh, India
            </li>
            <li className="flex items-center gap-2">
              <Phone size={16} /> +91 88659 60903
            </li>
            <li className="flex items-center gap-2">
...
<div className="text-center py-4 text-sm text-green-100 bg-green-800/40">
        © {new Date().getFullYear()} <span className="font-semibold">Canson</span>. All rights reserved.
      </div>
