...
function HeroSection() {
   ...
   const slides=[
    ...
    title: "Fresh Organic Jaggery Items 🥦",
    subtitle: "Fresh jaggery, organic flavours, and daily essentials delivered to you.",
    btnText: "Shop Now",
  ...
  },
  {
    ...
    subtitle: "We ensure your items reach your doorstep in no time.",
    btnText: "Order Now",
  ...
  },
  {
    ...
    subtitle: "Easy and seamless online jaggery shopping experience.",
    btnText: "Get Started",
